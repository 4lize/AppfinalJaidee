...
let supabase = SupabaseClient(supabaseURL: URL(string: "https://ebnamplbvcoxazbjylxl.supabase.co")!, supabaseKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVibmFtcGxidmNveGF6Ymp5bHhsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ2NzQ0MTYsImV4cCI6MjA4MDI1MDQxNn0.DQAH4A6kp0KwMUDus4cKbKZ1baQcI1nUrebOFaTWMwg")
let client = SupabaseClient(supabaseURL: URL(string: "https://ebnamplbvcoxazbjylxl.supabase.co")!, supabaseKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVibmFtcGxidmNveGF6Ymp5bHhsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NDY3NDQxNiwiZXhwIjoyMDgwMjUwNDE2fQ.P3jTqZC9Cb3EPJMmSWcHJErx7Ye6sikXBSWlSluT-XM")
